...
# Sans ce flag (inliné au build), le frontend reste en mode démonstration
# et n'appelle jamais l'API : lib/api/employees.ts::isEmployeeApiEnabled.
ARG NEXT_PUBLIC_EMPLOYEE_API_ENABLED=true
...
ENV NEXT_PUBLIC_EMPLOYEE_API_ENABLED=$NEXT_PUBLIC_EMPLOYEE_API_ENABLED
